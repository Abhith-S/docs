---
description: >-
  API Keys are based on Macaroons and include the capability to encode
  programmatic access restrictions into the API Key.
---
...
![Access is shared client-to-client](../../../../.gitbook/assets/tar-diagram-access.png)
